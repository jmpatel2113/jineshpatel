    ...
    <div className={styles.content}>
      ...
      <p className={styles.description}>I'm a senior at <strong>Rutgers University</strong> majoring in <strong>Computer Science</strong> with a minor in Business Administration. 
       ...
       <div className={styles.buttonRow}> 
        <a href="https://mailto:jmpatel2113@gmail.com" className={styles.contactResumeButton}>Contact Me</a>
        <a href="/jineshpatel/resume.pdf" className={styles.contactResumeButton} target="_blank" rel="noopener noreferrer">Show Resume</a>
      </div>  
